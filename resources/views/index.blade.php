        ...
        <div class="steps-5">
          <div class="process-container">
           <div class="process-item">
            <x-data-aos-delay title="Project Planing" icon1="pencil-square" span="1">
              <b>Ini adalah konten</b> untuk bagian pertama yang akan dianimasikan dengan AOS.
            </x-data-aos-delay>
           </div><!--End Process Item -->
           <div class="process-item">
            <x-data-aos-delay title="Development Phase" icon1="gear" span="2">
              <b>Ini adalah konten</b> untuk bagian pertama yang akan dianimasikan dengan AOS.
            </x-data-aos-dalay>
            </div><!--End Process Item -->
            <div class="process-item">
            <x-data-aos-delay title="Testing &amp; QA" icon1="search" span="3">
              <b>Ini adalah konten</b> untuk bagian pertama yang akan dianimasikan dengan AOS.
            </x-data-aos-delay>
            </div><!--End Process Item -->
            <div class="process-item">
            <x-data-aos-delay title="Launce &amp; Support" icon1="rocket-takeoff" span="4">
              <b>Ini adalah konten</b> untuk bagian pertama yang akan dianimasikan dengan AOS.
            </x-data-aos-delay>
            </div><!--End Process Item -->
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="service-list">
              ...
              <x-teknologi title="Business Analytics" icon3="graph-up">
                Lorem ipsum dolor sit amet consectetur adipiscing
              </x-teknologi>
              <x-teknologi title="Mobile Solutions" icon3="phone">
                Lorem ipsum dolor sit amet consectetur adipiscing
              </x-teknologi>
              <x-teknologi title="Tech Infrastructurer" icon3="gear">
                Lorem ipsum dolor sit amet consectetur adipiscing
              </x-teknologi>
              </div>
            </div>
